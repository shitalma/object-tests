...
public class PersonTest {
    ...
    @Test
    public void test_case_for_different_objects_have_different_values() throws Exception {
    ...
    @Test
    public void test_case_for_different_objects_have_case_sensitive_values() throws Exception {
    ...
    @Test
    public void test_case_for_same_objects_have_exact_same_value() throws Exception {
        Person p1 = new Person("shital", 18);
        Person p2 = new Person("shital", 18);
    ...
    @Test
    public void test_case_for_hash_code_for_case_sensitive_values() throws Exception {
        Person p1 = new Person("Shital", 18);
        Person p2 = new Person("shital", 18);
